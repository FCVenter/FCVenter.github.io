...
const HeroSection = ({ theme, toggleTheme }: HeroSectionProps) => (
  <section className="hero bg-gradient-to-br from-purple-600 to-green-500 text-white p-8 text-center">
    <div className="flex items-center justify-center mb-4">
      {/* Profile Card */}
      <Card size='lg' className="flex flex-col items-center bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white p-6 rounded-lg shadow-lg">
