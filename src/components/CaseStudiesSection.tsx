      ...
      <motion.div className="space-y-8" variants={sectionVariants}>
        ...
        >
          <Card
            ...
            role="article"
            aria-labelledby="airbnb-data-analysis"
          >
            <motion.h3
              id="airbnb-data-analysis"
            ...
            <motion.p
              ...
              variants={contentVariants}
            >
              <strong>Problem:</strong> A lack of actionable insights for
              optimizing Airbnb listings in Cape Town.
            </motion.p>
            <motion.p
              className={`${classes.textSizes.body}`}
              variants={contentVariants}
            >
              ...
              analysis, and visualization using Python and PostgreSQL to
              identify key trends in pricing, occupancy, and customer
              preferences.
            </motion.p>
            <motion.p
              className={`${classes.textSizes.body}`}
        ...
        {/* Add more case studies similarly */}
      </motion.div>
    </motion.section>
  );
};
